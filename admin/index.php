<?php
//Nama File: [index.php]
//Deskripsi: Untuk menampilkan Dashboard Admin
...
{
  //Jika admin belum melakukan login, maka akan pindah ke halaman login.php
    ...
    <div id="wrapper">
      ...
      >
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="index.html"><img src="assets/img/Logo.png" width="100px"><img src="" alt=""></a>
        </div>
        <div
          style="
            color: white;
